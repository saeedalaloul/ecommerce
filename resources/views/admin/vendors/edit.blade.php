...
@section('script')
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCI7nsFHDfJ9ngOveY1KmzYBCbHRPdjeto&libraries=places&callback=initAutocomplete&language=ar&region=Ps"></script>
@stop
