        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  <span
                      class="user-name text-bold-700">{{\Illuminate\Support\Facades\Auth::user()->name}}</span>
                </span>
                  ...
                  <img  style="height: 35px;" src="" alt="avatar"><i></i></span>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="assets/admin/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="assets/admin/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="assets/admin/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
